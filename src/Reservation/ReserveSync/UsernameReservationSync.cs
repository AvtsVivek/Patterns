...
public class UsernameReservationSync
{
    ...
    private void Expire(string username)
    {
        ...
        Console.WriteLine($"The user name {username} is removed from the reservation.");
        Console.WriteLine($"You can try again now. If the {username} is not registered, you can try again.");
    }
